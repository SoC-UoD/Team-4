...
import com.example.baddatatest.R;
...
public class MainActivity extends Activity {
	...
	private class DownloadStockData extends AsyncTask<String, Integer, String> {
		...
		protected String doInBackground(String... sUrl) {
			...
			// list of symbols
			stockSymbols = new String[] { "BP.L", "EXPN.L", "ABCDEF.L", "MKS.L",
					"SN.L" };
         ...
         protected void onPostExecute(String success) {
			...
			if (errorCount < 5) {
				...
				if (portfolio.length() > 6) {
					...
					tv_view.setText("Total portfolio value: £" + portfolio + "  -  " + displayDate);
				}
			} else {
